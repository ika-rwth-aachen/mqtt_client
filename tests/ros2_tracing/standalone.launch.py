...
def generate_launch_description():
    ...
    ping_node = LaunchConfiguration("ping_node")
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("ping_node", default_value="false", description="enable ping node"),
        ExecuteProcess(
            cmd=["ros2", "topic", "pub", "/ping/ros", "std_msgs/msg/String", "data: ping"],
            condition=IfCondition(ping_node),
        ),
        Node(
            package="mqtt_client",
